...
`define DBG_MODULE_UUID _e79b76589a9a4b6295de51a7fc21ce88
...
module edb_top (
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'he8e9c28e34e4494db98685d056be42e3 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 32 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 32 ),
...
module `DBG_MODULE_NAME(edb_adbg_crc32) (clk, data, enable, shift, clr, rstn, crc_out, serial_out);
    input         clk;
    input         data;
    input         enable;
    input         shift;
...
module `DBG_MODULE_NAME(debug_hub) #(
...
module `DBG_MODULE_NAME(edb_simple_dual_port_ram) #(
...
// May 2019, samh
//
module `DBG_MODULE_NAME(edb_la_top) #(
    ...
    localparam [31:0] PROBE0_DBUS_LSB = 32'h0;
    ...
    localparam [31:0] PROBE0_TBUS_LSB = 32'h0;
    ...
    localparam [31:0] PROBE0_CBUS_LSB = 32'h0;
    ...
    localparam [31:0] PROBE0_PBUS_LSB = 32'h0;
    ...
    // RTL version
    localparam [7:0] MAJOR_VERSION = 1;
    localparam [7:0] MINOR_VERSION = 2;
    ...
    assign data_from_internal_reg = (internal_register_select == INTREG_R0) ? {{(REG_WIDTH-R0_WIDTH){1'b0}}, internal_reg_r0} :
                                    ...
                                    (internal_register_select == INTREG_VERSION) ?  {48'd0, MINOR_VERSION, MAJOR_VERSION}:
    ...
    `DBG_MODULE_NAME(edb_adbg_crc32) axi_crc_i (
        .clk        ( bscan_TCK ), 
        .data       ( crc_data_in ),
        .enable     ( crc_en ),
    ...
    `DBG_MODULE_NAME(trigger_skipper)  #(
        .N_WIDTH(N_WIDTH)
    ) trigger_skipper_n (
        .clk                                ( clk ),
...
module `DBG_MODULE_NAME(fifo_address_trancode_unit) #(
...
module `DBG_MODULE_NAME(fifo_with_read) #(
    ...
    `DBG_MODULE_NAME(fifo_address_trancode_unit) #(
    ...
    assign data_in_with_status_bit = {is_last_data, din_p3[DATA_WIDTH -2:0]};
    ...
    `DBG_MODULE_NAME(edb_simple_dual_port_ram) #(
...
module `DBG_MODULE_NAME(la_biu) #(
    ...
    assign trig_pos_reached = (pos_counter == la_trig_pos - 1'b1);
    ...
    `DBG_MODULE_NAME(fifo_with_read) #(
...
module `DBG_MODULE_NAME(compare_unit) #(
    parameter WIDTH = 1,
    parameter PIPE = 0
)(
    input clk,
...
module `DBG_MODULE_NAME(trigger_unit) #(
    parameter WIDTH = 1,
    parameter TRIGIN_EN = 0,
    parameter PIPE = 0,
...
module `DBG_MODULE_NAME(trigger_skipper) #(parameter N_WIDTH = 64)( 
    input clk, 
    input resetn,
    input trigger_in,
